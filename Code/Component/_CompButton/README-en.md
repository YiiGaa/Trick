...
| _templ   | Button template                                              | Take the whole `child` as the template | Open type | 1.0=2024.11.15 |
...
| _class   | Style of the button                                          |                                        | String    | 1.0=2024.11.15<br/>1.1=2025.04.11 |
| _onClick | Button click callback                                        | No callback                            | Open type | 1.0=2024.11.15 |
| _prop    | Button label attribute settings, automatically expand and fill in the button label |                                        | Object    | 1.0=2024.11.15 |
...
- The recommended format is `comp##_CompButton<<[page layout]`, such as `comp##_CompButton<<Title`, `comp##_CompButton<<Title/Info`
...
You can also run `ShellExcute>>Build#Component` through `Christmas plug-in` and enter `_CompButton` in the terminal where the plug-in is opened
