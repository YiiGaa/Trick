...
| _map                | Option item settings                                         |                            | Array | 1.0=2024.11.15 |
...
- The parameter settings of the object `{}` are as follows
    ...
    | _class      | The outer layer style of the current option                  |                                        | String    | 1.1=2025.04.11       |
    | _classRadio | The checkbox style of the current option                     |                                        | String    | 1.1=2025.04.11       |
    | _classSpan  | The label style of the current option                        |                                        | String    | 1.1=2025.04.11       |
...
- The recommended format is `comp##_CompRadio<<[page layout]`, such as `comp##_CompRadio<<Title`, `comp##_CompRadio<<Title/Info`
...
You can also run `ShellExcute>>Build#Component` through `Christmas plug-in` and enter `_CompRadio` in the terminal where the plug-in is opened
...
- [update] Remove `_class`, `_classRadio`, ` _classRadioSpan` fields

- [update] Add `_class`, `_classRadio`, `_classSpan` fields under `_map`
