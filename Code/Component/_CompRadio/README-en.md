...
| _map                | Option item settings                                         |                            | Array/Object | 1.0=2024.11.15 |
| _classBody          | Outer style of the component                                 |                            | String       | 1.0=2024.11.15 |
| _classItem          | The outer style of the sub-item                              |                            | String       | 1.0=2024.11.15 |
| _classItemRadio     | Checkbox style of sub-items                                  |                            | String       | 1.0=2024.11.15 |
| _classItemRadioSpan | The label style of the sub-item                              |                            | String       | 1.0=2024.11.15 |
