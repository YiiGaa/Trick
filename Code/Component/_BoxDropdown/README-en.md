...
| _map         | Menu settings                                                |                                        | Array/Object | 1.0=2024.11.15 |
...
| _classItem   | Menu item general style                                      |                                        | String       | 1.0=2024.11.15 |
...
- Menu settings can be array embedded object `[{},{}]`, or a single object `{}`
...
- The parameter settings of the object `{}` are as follows
    ...
    | _classItem  | Menu item style                                              |                                        | String    | 1.0=2024.11.15       |
    | _onClick    | Menu item click callback, returns the data of the current menu item | No callback                            | Open type | 1.0=2024.11.15       |
    | _data       | Custom temporary storage data, the menu item will return when you click the callback | No callback                            | Open type | 1.0=2024.11.15       |
