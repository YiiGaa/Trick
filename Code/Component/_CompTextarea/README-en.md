...
| _textPlaceholder | Prompt words                                                 |                            |           |                |
| _value           | Content                                                      |                            | String    | 1.0=2024.11.15 |
| _rows            | The number of text lines displayed                           | 5                          | Int       | 1.0=2024.11.15 |
...
- The recommended format is `comp##_CompTextarea<<[page layout]`, such as `comp##_CompTextarea<<Title`, `comp##_CompTextarea<<Title/Info`
...
```
Python3 Christmas/Christmas.py ShellExcute/Build#Component _CompTextarea

```

You can also run `ShellExcute>>Build#Component` through `Christmas plug-in` and enter `_CompTextarea` in the terminal where the plug-in is opened
