...
| _isAble          | Whether it can be modified, true: Yes, false: read-only      | true                       | Bool      | 1.0=2024.11.15 |
| _name            | Name attribute of html tag                                   |                            | String    | 1.0=2024.11.15 |
| _textPlaceholder | The prompt of the input tag                                  |                            | String    | 1.0=2024.11.15 |
| _value           | Input content                                                |                            | String    | 1.0=2024.11.15 |
| _class       | The style of the component                                   |                            | String    | 1.0=2024.11.15<br>1.1=2025.04.11 |
| _onChange        | Input change callback                                        | No callback                | Open type | 1.0=2024.11.15 |
| _prop            | Attribute settings of the input label, automatically expand to fill in the input label |                            | Object    | 1.0=2024.11.15 |
...
- The recommended format is `comp##_CompInput<<[page layout]`, such as `comp##_CompInput<<Title`, `comp##_CompInput<<Title/Info`
...
```
Python3 Christmas/Christmas.py ShellExcute/Build#Component _CompInput

```

You can also run `ShellExcute>>Build#Component` through `Christmas plug-in` and enter `_CompInput` in the terminal where the plug-in is opened
