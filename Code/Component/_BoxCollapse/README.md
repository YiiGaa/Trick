...
| _initOpen    | 初始化时，是否打开，true：打开，false：隐藏       | true   | Bool | 1.0=2024.11.15 |
| _templButton | 打开/隐藏按钮模板 | 以整个`child`作为模板 | 开放类型 | 1.0=2024.11.15 |
| _templPanel | 内容模板 | 以整个`child`作为模板 | 开放类型 | 1.0=2024.11.15 |
| _class | 组件的外层样式 |  | String | 1.0=2024.11.15<br>1.1=2025.04.11 |
| _classButton | 打开/隐藏按钮外层样式 |  | String | 1.0=2024.11.15 |
| _classPanel | 隐藏内容外层样式 |  | String | 1.0=2024.11.15 |
...
- 推荐格式为`comp##_BoxCollapse<<[所在页面布局]`，如`comp##_BoxCollapse<<Title`、`comp##_BoxCollapse<<Title/Info`
...
| key     | 说明                                          | 默认值       | 类型   | 组入/更新版本  |
| ------- | --------------------------------------------- | ------------ | ------ | -------------- |
| _action | 固定为"switch"                                |              | String | 1.0=2024.11.15 |
| _isOpen | 是否显示内容，true：显示内容，false：隐藏内容 | 自动切换状态 | Bool   | 1.0=2024.11.15 |
...
也可以通过`Christmas插件`运行`ShellExcute>>Build#Component`，并在插件打开的终端中输入`_BoxCollapse`
