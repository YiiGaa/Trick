...
| _active | 显示第几个内容 | 0 | Int | 1.0=2024.11.15 |
| _map | Tabs子项设置                               |                | Array/Object | 1.0=2024.11.15 |
| _classBody | 组件的外层样式                          |                       | String   | 1.0=2024.11.15 |
| _classTabs | 菜单的外层样式 | | String | 1.0=2024.11.15 |
| _classTabsItem | 菜单子项的样式 | | String | 1.0=2024.11.15 |
| _classPanel | 内容的外层样式 | | String | 1.0=2024.11.15 |
| _classPanelItem | 内容子项的样式 | | String | 1.0=2024.11.15 |

参数补充说明：

### > _map

- Tabs子项设置，可以是数组内嵌对象`[{},{}]`，或者单个对象`{}`
