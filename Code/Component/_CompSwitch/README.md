...
| _templ | 标签内容模板                         | 以整个`child`作为模板 | 开放类型 | 1.0=2024.11.15 |
...
| _isAble | 是否激活，true：激活，false：未激活 | true | Bool | 1.0=2024.11.15 |
| _class | 组件的外层样式 |  | String | 1.0=2024.11.15<br>1.1=2025.04.11 |
| _classSlot | 切换槽的样式 |  | String | 1.0=2024.11.15 |
| _classBar | 切换按钮的样式                   |                       | String   | 1.0=2024.11.15 |
| _classLabel | 标签的外层样式 | | String | 1.0=2024.11.15 |
| _prop | Html标签的属性设置，自动展开填入 | | String | 1.0=2024.11.15 |
| _onClick | 点击回调 | 不回调 | 开放类型 | 1.0=2024.11.15 |
...
- 推荐格式为`comp##_CompSwitch<<[所在页面布局]`，如`comp##_CompSwitch<<Title`、`comp##_CompSwitch<<Title/Info`
...
也可以通过`Christmas插件`运行`ShellExcute>>Build#Component`，并在插件打开的终端中输入`_CompSwitch`
