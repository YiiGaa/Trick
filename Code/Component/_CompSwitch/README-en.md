...
| _templ      | Label content template                                       | Take the whole `child` as the template | Open type | 1.0=2024.11.15 |
| _name       | Name attribute of html tag                                   |                                        | String    | 1.0=2024.11.15 |
| _isAble     | Whether to activate, true: activated, false: not activated   | true                                   | Bool      | 1.0=2024.11.15 |
| _classBody  | The outer style of the component                             |                                        | String    | 1.0=2024.11.15 |
| _classSlot  | The style of switching slot                                  |                                        | String    | 1.0=2024.11.15 |
| _classBar   | The style of the switch bar                                  |                                        | String    | 1.0=2024.11.15 |
| _classLabel | The outer style of the label                                 |                                        | String    | 1.0=2024.11.15 |
| _prop       | Html tag attribute settings, automatically expand and fill in |                                        | String    | 1.0=2024.11.15 |
| _onClick    | Click callback                                               | No callback                            | Open type | 1.0=2024.11.15 |
...
- The recommended format is `comp##_CompSwitch<<[page layout]`, such as `comp##_CompSwitch<<Title`, `comp##_CompSwitch<<Title/Info`
...
```
Python3 Christmas/Christmas.py ShellExcute/Build#Component _CompSwitch

```

You can also run `ShellExcute>>Build#Component` through `Christmas plug-in` and enter `_CompSwitch` in the terminal where the plug-in is opened
