...
| _map        | Form sub-item template                                       |                            | Array/Object | 1.0=2024.11.15 |
| _textError  | When the sub-item is wrong, the text prompted                |                            | String       | 1.0=2024.11.15 |
| _classBody  | Outer layer style of components                              |                            | String       | 1.0=2024.11.15 |
...
- Form item template settings can be array embedded object `[{},{}]`, or a single object `{}`
