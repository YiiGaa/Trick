...
| _isLoad | 是否显示加载动画，true：显示加载骨架，false：显示`child`内容 | true | Bool | 1.0=2024.11.15 |
| _class | 组件的外层样式                          |                       | String   | 1.0=2024.11.15<br>1.1=2025.04.11 |
| _classChild | `child`显示时的外层div样式 | | String | 1.0=2024.11.15 |
| _classLoadItem | 骨架图子项样式 | | String | 1.0=2024.11.15 |
| _classLoadList | 骨架图子项设置，设置每一行的样式，如果设置为`[]`,则单行铺满 | ["","","!w-9/12"] | Array | 1.0=2024.11.15 |
| _classLoad | 骨架图外层样式 | | String | 1.0=2024.11.15 |
...
- 推荐格式为`comp##_Funload<<[所在页面布局]`，如`comp##_Funload<<Title`、`comp##_Funload<<Title/Info`
...
也可以通过`Christmas插件`运行`ShellExcute>>Build#Component`，并在插件打开的终端中输入`_Funload`
