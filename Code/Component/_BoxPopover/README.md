...
| _templButton | 按钮模板                       | 以整个`child`作为模板 | 开放类型 | 1.0=2024.11.15 |
| _templPanel | 弹出框模板 | 以整个`child`作为模板 | 开放类型 | 1.0=2024.11.15 |
| _styleAnchor | 弹出框打开位置，`bottom/top/left/right` | bottom | String | 1.0=2024.11.15 |
| _classButton | 按钮样式 |  | String | 1.0=2024.11.15 |
| _classPanel | 弹出框样式                     |                       | String   | 1.0=2024.11.15 |
...
- 推荐格式为`comp##_BoxPopover<<[所在页面布局]`，如`comp##_BoxPopover<<Title`、`comp##_BoxPopover<<Title/Info`
...
| key     | 说明         | 默认值 | 类型   | 组入/更新版本  |
| ------- | ------------ | ------ | ------ | -------------- |
| _action | 固定为"show" |        | String | 1.0=2024.11.15 |
...
也可以通过`Christmas插件`运行`ShellExcute>>Build#Component`，并在插件打开的终端中输入`_BoxPopover`
